...
class SelfAffectiveMemory:
    ...
    def __init__(
        ...
        (
            self.numberOfEpochs,
            self.insertionThreshold,
            self.learningRateBMU,
            self.learningRateNeighbors,
        ) = (numberOfEpochs, insertionThreshold, learningRateBMU, learningRateNeighbors)
