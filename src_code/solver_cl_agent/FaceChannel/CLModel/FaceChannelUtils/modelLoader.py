...
from CLModel.FaceChannelUtils.imageProcessingUtil import imageProcessingUtil
import CLModel.FaceChannelUtils.metrics as metrics
...
class modelLoader:
    ...
    def getDense(self, image):
        ...
        denseRepresentation = classifier.predict(
            numpy.array([image]), batch_size=self.BATCH_SIZE
        )
