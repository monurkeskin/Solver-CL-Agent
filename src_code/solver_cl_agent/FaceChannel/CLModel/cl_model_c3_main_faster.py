...
def generate_encodings_facechannel(path_to_dir, mode="imagine"):
    """
    dataX: Imagine,
...
def apply_network_to_images_of_dir(
    loadPath, path_to_dir="./logs/faces/", path_to_out_dir="./logs/faces_imagined/"
):
    """
    ...
    return generate_encodings_facechannel(path_to_dir=path_to_out_dir, mode="imagine")
...
def get_arousal_valence(log_dir: str, use_imagined: bool = True):
    ...
    input_data, input_labels = generate_encodings_facechannel(
        path_to_dir=log_dir + "faces/", mode="input"
    )
    ...
    encodings, face_time_stamps = generate_encodings_facechannel(
        path_to_dir=log_dir + "faces/", mode="encode"
    )
