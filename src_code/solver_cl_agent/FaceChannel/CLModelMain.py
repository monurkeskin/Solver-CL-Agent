"""
CLIFER Model Entry Point

Standalone script for testing the CL affect perception model.
"""

# Note: Windows-specific CUDA paths (commented out for cross-platform compatibility)
# import os
