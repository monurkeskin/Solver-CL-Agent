...
- `Concession_Rate`: Frequency of concession moves (Stepwise Analysis). (p=0.009, d=0.33).
...
- **Agent Utility**: CL (0.75) > FC (0.73), p=0.005, d=0.36.
- **Efficiency**: CL (7.3 rounds) < FC (8.7 rounds), p=0.03, d=0.27.
- **Concession Rate**: CL (0.38) > FC (0.28), p=0.009, d=0.33.
- **Arousal Sensitivity**: CL (μ=0.15) > FC (μ=0.01), d=0.88.
- **Generalization**: 75.8% of subjects showed improved arousal sensitivity with CL.
